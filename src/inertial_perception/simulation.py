...
def run_simulation(scenario='combined',duration=10.,seed=42,camera_enabled=True,range_enabled=True,imu_hz=200,camera_hz=15,range_hz=15):
    ...
    est=AttitudeEstimator(initial_orientation=truth_at(0,scenario).orientation);dt=1/imu_hz;next_cam=next_range=0.;records=[];last_cam=last_range=last_cam_gt=last_range_gt=None
